...
$(document).ready( function() {
      $.ajax({
            ...
            data: ''
                  ...
                  var placeholder = '<div style="border: #444 2px solid; height: 100%; width: 100%;'; 
                  placeholder += 'object-fit: contain">No camera feed available.</div>';
                  document.getElementById('dome-cam').innerHTML = placeholder;
            });
      });
